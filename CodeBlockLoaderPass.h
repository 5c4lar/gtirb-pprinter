...
#ifndef DDISASM_CodeBlockLoaderPass_H
#define DDISASM_CodeBlockLoaderPass_H
...
*/
class CodeBlockLoaderPass : public AnalysisPass
{
public:
    explicit CodeBlockLoaderPass(gtirb::Module& referenceModule) : ReferenceModule(referenceModule)
    {}
    virtual std::string getName() const override
    {
        return "CodeBlock loader";
    }
...
#endif // DDISASM_CodeBlockLoaderPass_H
